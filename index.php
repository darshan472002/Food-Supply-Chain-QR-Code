    ...
    <div style="width: 100%">
      <center>
        <div class="loginformcard" id="card1">
          <h2 style="font-weight:800;"><b> Welcome to Food Supply Chain DAPP</b></h2><br>
          ...
          <div class="cardbtnarea">
            ...
            <button class="col-md-5 rolebtn" id="signup">Sign up</button>
          </div>
        </div>


        <div class="loginformcard1" id="maincard3">
          <h4 style="font-weight:800;"> Create your new account</h4>
          <form style="margin-top: 30px; margin-bottom: 30px;" action="registration.php" method="POST" onsubmit="return checkSecondForm(this);">

            <label type="text" class="formlabel" style="margin-top: 15px; text-align:left; font-weight: 400;"><b> Email ID: </b></label>
            <input type="text" class="forminput" name="email" id="email" onkeypress="isNotChar(event)" required>

            <label type="text" class="formlabel" id="username-label" style="margin-top: 15px; text-align:left; font-weight: 400;"><b> Username: </b></label>
            <input type="text" class="forminput" name="username" id="username" onkeypress="blockSpaces(event)" required>

            <label type="text" class="formlabel" style="margin-top: 15px; text-align:left; font-weight: 400;"><b> Password: </b></label>
            <input type="password" class="forminput" name="pw" id="pw" onkeypress="isNotChar(event)" required>

            <label type="text" class="formlabel" style="margin-top: 15px; text-align:left; font-weight: 400;"><b> Confirm Password: </b></label>
            <input type="password" class="forminput" name="cpw" id="cpw" onkeypress="isNotChar(event)" required>

            <label type="text" class="formlabel" style="margin-top: 10px; text-align:left; font-weight: 400;"><b> Select A Role: </b></label>
            ...
            <button class="formbtn" name="loginsubmit" value="submitted!" type="submit">SIGN UP</button>

            <br>
            <a href="#" id="gotologin" style="font-weight: 400;"> Already Haven't Account? Login </a>
          </form>
        </div>


        <div class="loginformcard" id="maincard2">
          <h4 style="font-weight:800;"> Login to your existing account</h4>
          <form style="margin-top: 30px; margin-bottom: 30px;" action="login.php" method="POST" onsubmit="return checkFirstForm(this);">

            <label type="text" class="formlabel" style="text-align:left; font-weight: 400;"><b> Email ID: </b></label>
            <input type="text" class="forminput" name="email" id="email" onkeypress="isNotChar(event)" required>
            ...
            <br>
            <a href="#" id="gotosignup" style="font-weight: 400;"> Don't have an account? Sign Up</a>
          </form>
