...
<head>
  ...
  <title>SupplyChain - Create New Account</title>
      ...
      <center>
        <div class="loginformcard" id="card1">
          ...
          <form style="margin-top: 30px; margin-bottom: 30px;" action="registration.php" method="POST" onsubmit="return checkform(this);">
            ...
            <label type="text" class="formlabel" style=" text-align:left; font-weight: 400;"> Email ID: </label>
            <input type="text" class="forminput" value="<?php echo $email; ?>" name="email" onkeypress="isNotChar(event)" required>

            <label type="text" class="formlabel" style="margin-top: 10px; text-align:left; font-weight: 400;"> Userame: </label>
            ...
            <label type="text" class="formlabel" style="margin-top: 10px; text-align:left; font-weight: 400;"> Confirm Password </label>
