      ...
      <center>
        <div class="centered">
          <form role="form" autocomplete="off">
            <input type="text" id="searchText" class="searchBox" placeholder="Enter Product Id" onkeypress="isInputNumber(event)" required>
          ...
          if (res instanceof Error) {
            ...
            $.ajax({
              ...
              success: function(response) {
                ...
                // Set the product ID in the search input field
                $("#searchText").val(response);
                // Trigger a click event on the search button to initiate the search
                $("#searchButton").click();
              },
